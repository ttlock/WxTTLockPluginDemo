...
/** @description 获取智能锁版本信息 */
interface TTLockGetVersion {
    /* 扫描到的智能锁信息 */
    deviceFromScan: TTLockFromScan;
    /* 设备断连回调 */
    disconnectCallback?: TTLockCallback;
}

/** 初始化智能锁参数 */
interface TTLockInit {
    /* 扫描到的智能锁信息 */
    deviceFromScan: TTLockFromScan;
    /* 设备断连回调 */
    disconnectCallback?: TTLockCallback;
...
interface TTLockControl {
    ...
    /* 服务器时间戳，用于校准服务器时间，不传则默认从服务器获取时间戳，获取失败后取本地时间 */
    serverTime?: number;
    /* 开锁成功后是否跳过校准锁时间 */
    noCorrectAfterUnlock?: boolean;
}
