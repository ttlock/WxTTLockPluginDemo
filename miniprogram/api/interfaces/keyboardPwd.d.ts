namespace IKeyboardPwdAPI.Params {
    /** 添加密码参数 */
    interface Add {
...
namespace IKeyboardPwdAPI.List {
    /** 电子钥匙信息 */
    interface EKeyInfo {
        lockId?: number; // 智能锁ID
        keyId?: number; // 电子钥匙ID
...
namespace IKeyboardPwdAPI.Result {
    /** 电子钥匙列表返回数据 */
    interface List extends ResultListData<IEKeyAPI.List.EKeyInfo>, HttpResponseError {}
}