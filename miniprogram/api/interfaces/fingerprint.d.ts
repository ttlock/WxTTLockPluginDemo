namespace IFingerprintAPI.Params {
    /** 指纹列表请求参数 */
    interface List {
        lockId: number; // 智能锁ID
...
namespace IFingerprintAPI.Value {
...
namespace IFingerprintAPI.List {
    /** 指纹信息参数 */
...
namespace IFingerprintAPI.Result {
    /** 指纹列表返回数据 */
    interface FingerprintList extends ResultListData<IFingerprintAPI.List.FingerprintInfo>, HttpResponseError {}

    /** 添加指纹参数 */
    interface Add extends HttpResponseError {
        fingerprintId?: number; // 指纹ID
    }
}