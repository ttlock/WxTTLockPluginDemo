...
namespace ICardAPI.Result {
    /** IC卡列表返回数据 */
    interface CardList extends ResultListData<ICardAPI.List.CardInfo>, HttpResponseError {}
