...
#### <span name="TTLockGetRemoteUnlockSwitchStateResult">查询智能锁远程开关开启状态返回结果</span>  
 ...
 |------------------|-----------|-----------------------|-----------------------|-----------|
 |enable            |boolean    |3.1.0 & offline-2.1.0  |                       |远程开关开启状态|
 |enabled           |boolean    |                       |3.1.0 & offline-2.1.0  |远程开关开启状态, 3.1.0版本开始更名为enable, 该版本不返回该参数|
 |lockData          |string     |                       |                       |智能锁更新数据，用于上传服务器，**不可用于智能锁蓝牙操作**|
 |featureValue      |string     |2.3.1 & offline-1.3.1  |                       |智能锁更新后特征值(完整数据)|
 |specialValue      |number     |                       |2.3.1 & offline-1.3.1  |智能锁更新后特征值(低位数据，兼容低版本)|  
