# 通通锁蓝牙模块通信插件接口说明文档 (version: 3.1.7 & offline-2.1.5)  
...
+ [解析智能锁版本类型](./非蓝牙接口/getLockType.md)  
...
#### 人脸管理  
+ [添加人脸](./智能锁接口/addFace.md)  
+ [修改人脸有效期](./智能锁接口/modifyFaceValidityPeriod.md)  
...
#### 特殊功能  
+ [获取Cat.1模块信息](./智能锁接口/getCatOneInfo.md)  
+ [配置Cat.1锁APN](./智能锁接口/configApn.md)  
