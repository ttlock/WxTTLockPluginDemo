# 通通锁蓝牙模块通信插件接口说明文档-离线版 (version: 1.x)
...
###### 参数
+ featureValue:锁的特征值, 可传入featureValue或者specialValue, 1.4.1版本开始支持传入featureValue
...
```
    interface TTLock.LockFeatureValue {
        ...
        updateHardware: boolean; // 是否支持固件升级（**1.7.0版本新增**）
...
+ -4              -用户中断操作(**1.9.0新增**)
+ -3              -设备响应超时，通信失败(**1.6.0新增**)
+ -2              -操作未结束，等待下一次操作(**1.6.0新增**)
+ -1              -最后一次回调，断连不再进行设备回调(**1.6.0新增**)
+ 0               -OK (操作成功)
...
+ 36              -指令已接收，正在处理中, 请稍候**1.7.6新增**
+ 37              -无效的SSID，智能锁无法使用该网络(WIFI锁配置SSID错误)**1.7.6新增**
+ 38              -WIFI密码错误**1.7.6新增**

+ 128             -网关操作失败**1.6.0新增**
+ 129             -指令已接收，正在处理中, 请稍候**1.6.0新增**（一般不返回）
+ 130             -无效的SSID，网关无法使用该网络**1.6.0新增**
+ 131             -WIFI密码错误**1.6.0新增**
+ 132             -处理已完成**1.6.0新增**（一般不返回）
+ 133             -无效指令**1.6.0新增**
+ 134             -指令超时**1.6.0新增**
+ 135             -设备未插入SIM卡**1.6.0新增**
+ 136             -设备无法连接网络**1.6.0新增**
...
+ 10011           -网关未进入可添加模式，请重新通电后扫描(**1.7.0新增**)
+ 10012           -系统蓝牙功能未开启(**1.7.0新增**)
+ 10013           -系统蓝牙功能未开启或用户未授权予微信蓝牙权限(iOS)(**1.7.0新增**)
+ 10014           -用户未授权予微信蓝牙权限(iOS)(**1.7.0新增**)
+ 10015           -用户未授权予微信位置权限(安卓)(**1.7.0新增**)
+ 10016           -设备未扫描到可用WIFI(**1.7.0新增**)
+ 10017           -设备通信超时未响应(**1.7.0新增**)
+ 10018           -蓝牙特征值不存在(**1.7.0新增**)
+ 10019           -配置WIFI信息失败，请检查WIFI信息及网络状态(无效的WIFI信息或网络状态差)(**1.7.0新增**)
+ 10020           -配置远程服务器失败，请检查服务器配置信息及网络状态(**1.7.0新增**)
+ 10021           -设备未响应，请重试(**1.7.0新增**)
+ 10022           -操作已中断(**1.7.6新增**)
...
+ 10037           -正在连接设备，无法中止，请稍候**1.6.0新增**
+ 10038           -微信基础库版本过低，请升级(**1.7.0新增**, 需2.14.1及其以上)
+ 10039           -小程序蓝牙授权未开启(**1.9.2新增**, 返回后自动跳转小程序授权页面)
+ 11001           -设备暂不支持该操作
+ 11002           -设备或平台不支持蓝牙功能调试**1.0.2新增**
+ 11003           -参数错误**1.1.0新增**
+ 11004           -智能锁不支持该功能**1.1.0新增**
+ 11005           -非管理员用户，无权操作**1.1.0新增**
+ 11006           -无效的锁数据**1.1.0新增**
+ 11007           -无效的锁时间**1.1.0新增**
+ 11008           -无效的楼层编号列表**1.1.0新增**
+ 11009           -密码为4-9位数字字符串**1.1.0新增**
+ 11010           -时间不在有效期内**1.1.0新增**
+ 11011           -结束时间不能早于开始时间**1.1.1新增**
+ 11012           -无效的酒店信息**1.4.0新增**
+ 11013           -蓝牙正在操作中，请稍候再试**1.4.0新增**
+ 11014           -无效的楼栋楼层信息**1.4.0新增**
+ 11101           -服务器请求失败**1.8.0新增**