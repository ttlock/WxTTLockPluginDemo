...
## <span name="TTLockVersion">TTLockVersion 智能锁版本信息</span>  
...
## <span name="TTLockFromScan">TTLockFromScan 蓝牙扫描到的智能锁设备</span>  
 |NAME                          |TYPE                               |VERSION    |DESCRIPTION|
 |------------------------------|-----------------------------------|-----------|-----------|
 |deviceType                    |[TTDEVICE_TYPE](../参数声明/设备通用参数.md#TTDEVICE_TYPE) |2.7.6      |设备类型|
 |type                          |[TTLOCK_TYPE](../参数声明/智能锁参数.md#TTLOCK_TYPE)       |2.7.0      |智能锁类型|
...
## <span name="TTLockFeatureValue">TTLockFeatureValue 智能锁特征值解析结果</span>  
 |NAME                          |TYPE           |VERSION    |DESCRIPTION|
 |------------------------------|---------------|-----------|-----------|
