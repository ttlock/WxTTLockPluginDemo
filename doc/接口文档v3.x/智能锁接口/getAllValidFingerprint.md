# 通通锁蓝牙模块通信插件接口v3.x - getAllValidFingerprint
[返回接口文档](../../README.md)  
<br />
...
function getAllValidFingerprint(lockData: string, disconnectCallback?: TTLockCallback): Promise<TTLockGetAllValidFingerprintResult>
```  
<br />
