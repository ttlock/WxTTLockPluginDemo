# 通通锁蓝牙模块通信插件接口v3.x - configPassageMode
[返回接口文档](../../README.md)  
<br />
...
## 参数说明 
 ...
 |----------------------|-------------------------------------------------------------------|--------------|----------------|-----------|
 |option                |[TTLockConfigPassageMode](#TTLockConfigPassageMode)                |Y             |IN              |完整参数|
 |config                |[TTLockPassageModeConfiguration](#TTLockPassageModeConfiguration)  |Y             |IN              |智能锁常开模式配置|
 |lockData              |string                                                             |Y             |IN              |**管理员**电子钥匙数据|
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)                                  |N             |OUT             |设备断开连接回调|
<br />

### <span name="TTLockConfigPassageMode">设置常开模式完整参数 TTLockConfigPassageMode</span>  
 |PARAMS                |TYPE                                                               |REQUIRED      |IN/OUT          |DESCRIPTION|
 |----------------------|-------------------------------------------------------------------|--------------|----------------|-----------|
 |config                |[TTLockPassageModeConfiguration](#TTLockPassageModeConfiguration)  |Y             |IN              |智能锁常开模式配置|
 |lockData              |string                                                             |Y             |IN              |**管理员**电子钥匙数据|
...
### <span name="TTTLockPassageModeConfiguration">设置常开模式完整参数 TTLockPassageModeConfiguration</span>  
 |PARAMS                |TYPE                                                   |REQUIRED      |IN/OUT          |DESCRIPTION|
 |----------------------|-------------------------------------------------------|--------------|----------------|-----------|
 |type                  |[TTLOCK_PASSAGE_WORKMODE](#TTLOCK_PASSAGE_WORKMODE)    |Y             |IN              |智能锁常开工作模式，1 -按周常开, 2 -按月常开|
 |repeatWeekOrDays      |Array<number>                                          |Y             |IN              |常开日，周模式传入1-7组成的整数数组，分别表示周一~周日，月模式传入1-31的整数数组，表示常开日期|
 |startDate             |number                                                 |Y             |IN              |常开开始分钟数|
 |endDate               |number                                                 |Y             |IN              |常开结束分钟数|
<br />
