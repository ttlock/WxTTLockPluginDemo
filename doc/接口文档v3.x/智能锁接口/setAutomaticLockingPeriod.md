# 通通锁蓝牙模块通信插件接口v3.x - setAutomaticLockingPeriod
[返回接口文档](../../README.md)  
<br />

## 方法
```
function setAutomaticLockingPeriod(option: TTLockSetAutomaticLockingPeriod): Promise<TTLockError>
...
## 参数说明 
 ...
 |----------------------|-----------------------------------------------------------------------|--------------|----------------|-----------|
 |option                |[TTLockSetAutomaticLockingPeriod](#TTLockSetAutomaticLockingPeriod)    |Y             |IN              |完整参数|
 |seconds               |number                                                                 |Y             |IN              |自动闭锁时间，单位：秒，0表示关闭超时自动闭锁|
 |lockData              |string                                                                 |Y             |IN              |**管理员**电子钥匙数据|
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)                                      |N             |OUT             |设备断开连接回调|
<br />

### <span name="TTLockSetAutomaticLockingPeriod">设置自动闭锁时间完整参数 TTLockSetAutomaticLockingPeriod</span>  
 |PARAMS                |TYPE                                   |REQUIRED      |IN/OUT          |DESCRIPTION|
 |----------------------|---------------------------------------|--------------|----------------|-----------|
 |seconds               |number                                 |Y             |IN              |自动闭锁时间，单位：秒，0表示关闭超时自动闭锁|
 |lockData              |string                                 |Y             |IN              |**管理员**电子钥匙数据|
