# 通通锁蓝牙模块通信插件接口v3.x - addFingerprint
[返回接口文档](../../README.md)  
<br />
...
): Promise<TTLockAddFingerprintResult>
```  
<br />
...
## 参数说明 
 ...
 |----------------------|---------------------------------------------------------------|--------------|----------------|-----------|
 |option                |[TTLockAddFingerprint](#TTLockAddFingerprint)                  |Y             |IN              |全部参数|
...
### <span name="TTLockAddFingerprint">添加指纹全部参数 TTLockAddFingerprint</span>  
 |PARAMS                |TYPE                                                           |REQUIRED       |IN/OUT          |DESCRIPTION|
 |----------------------|---------------------------------------------------------------|---------------|----------------|-----------|
 |startDate             |number                                                         |Y              |IN              |指纹有效期开始时间，生效值精确到分钟|
 |endDate               |number                                                         |Y              |IN              |指纹有效期结束时间，生效值精确到分钟|
