# 通通锁蓝牙模块通信插件接口v3.x - clearPassageMode
[返回接口文档](../../README.md)  
<br />
...
function clearPassageMode(lockData: string, disconnectCallback?: TTLockCallback): Promise<TTLockError>
```  
<br />
...
## 参数说明 
 ...
 |----------------------|---------------------------------------------------|--------------|----------------|-----------|
 |option                |[TTLockClearPassageMode](#TTLockClearPassageMode)  |Y             |IN              |完整参数|
 |lockData              |string                                             |Y             |IN              |**管理员**电子钥匙数据|
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)                  |N             |OUT             |设备断开连接回调|
<br />

### <span name="TTLockClearPassageMode">清空常开模式完整参数 TTLockClearPassageMode</span>  
 |PARAMS                |TYPE                                               |REQUIRED      |IN/OUT          |DESCRIPTION|
 |----------------------|---------------------------------------------------|--------------|----------------|-----------|
 |lockData              |string                                             |Y             |IN              |**管理员**电子钥匙数据|
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)                  |N             |OUT             |设备断开连接回调|
