# 通通锁蓝牙模块通信插件接口v3.x - getLockConfig
[返回接口文档](../../README.md)  
<br />
...
): Promise<TTLockGetLockConfigResult>
```  
<br />
...
## 参数说明 
 ...
 |----------------------|---------------------------------------------------|--------------|----------------|-----------|
 |option                |[TTLockGetLockConfig](#TTLockGetLockConfig)        |Y             |IN              |完整参数|
 ...
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)                  |N             |OUT             |设备断开连接回调|
    ...
    1. configType支持组合查询，如 1|2 表示同时查询防撬开关及长按重置智能锁按键开关状态
<br />

### <span name="TTLockGetLockConfig">查询智能锁开关配置状态完整参数 TTLockGetLockConfig</span>  
 |PARAMS                |TYPE                                               |REQUIRED      |IN/OUT          |DESCRIPTION|
 |----------------------|---------------------------------------------------|--------------|----------------|-----------|
 |configType            |number                                             |Y             |IN              |开关配置属性 [TTLOCK_SWITCH_CONFIG_TYPE](#TTLOCK_SWITCH_CONFIG_TYPE)|
 |lockData              |string                                             |Y             |IN              |**管理员**电子钥匙数据|
...
## 固定参数补充说明  
### <span name="TTLOCK_SWITCH_CONFIG_TYPE">TTLOCK_SWITCH_CONFIG_TYPE 智能锁开关配置属性</span>  
 [更多信息](../参数声明/智能锁参数.md#TTLOCK_SWITCH_CONFIG_TYPE)  
