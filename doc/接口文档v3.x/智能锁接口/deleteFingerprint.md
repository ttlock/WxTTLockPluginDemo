# 通通锁蓝牙模块通信插件接口v3.x - deleteFingerprint
[返回接口文档](../../README.md)  
<br />
...
## 参数说明 
 ...
 |----------------------|-------------------------------------------------------|--------------|----------------|-----------|
 |option                |[TTLockDeleteFingerprint](#TTLockDeleteFingerprint)    |Y             |IN              |全部参数|
 |fingerprintNum        |number                                                 |Y             |IN              |指纹号|
 |lockData              |string                                                 |Y             |IN              |**管理员**电子钥匙数据|
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)                      |N             |OUT             |设备断开连接回调|
<br />

### <span name="TTLockDeleteFingerprint">删除指纹全部参数 TTLockDeleteFingerprint</span>  
 |PARAMS                |TYPE                                           |REQUIRED      |IN/OUT          |DESCRIPTION|
 |----------------------|-----------------------------------------------|--------------|----------------|-----------|
 |fingerprintNum        |number                                         |Y             |IN              |指纹号|
 |lockData              |string                                         |Y             |IN              |**管理员**电子钥匙数据|
