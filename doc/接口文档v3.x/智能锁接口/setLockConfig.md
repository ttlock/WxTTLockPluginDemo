...
): Promise<TTLockSetLockConfigResult>
```  
<br />
 ...
 **支持同时设置多个属性时，如需同时设置重置按键属性和防撬开关配置属性时，configType传入3**  
 **3.0.0版本支持option调用模式**  
<br />
...
### <span name="TTLockSetLockConfigResult">智能锁开关配置状态设置结果 TTLockSetLockConfigResult extends TTLockError</span>  
