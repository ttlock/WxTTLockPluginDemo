# 通通锁蓝牙模块通信插件接口v3.x - getAllValidPasscode
[返回接口文档](../../README.md)  
<br />
...
function getAllValidPasscode(lockData: string, disconnectCallback?: TTLockCallback): Promise<TTLockGetAllValidPasscodeResult>
```  
<br />
...
## 参数说明 
 ...
 |----------------------|-----------------------------------------------------------|--------------|----------------|-----------|
 |option                |[TTLockGetAllValidPasscode](#TTLockGetAllValidPasscode)    |Y             |IN              |读取智能锁密码完整参数|
 |lockData              |string                                                     |Y             |IN              |**管理员**电子钥匙数据|
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)                          |N             |OUT             |设备断开连接回调|
<br />

### <span name="TTLockGetAllValidPasscode">|读取智能锁密码完整参数 TTLockGetAllValidPasscode</span>  
 |PARAMS                |TYPE                               |REQUIRED       |IN/OUT          |DESCRIPTION|
 |----------------------|-----------------------------------|---------------|----------------|-----------|
 |lockData              |string                             |Y              |IN              |**管理员**电子钥匙数据|
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)  |N              |OUT             |设备断开连接回调|
...
## 固定参数补充说明  
### <span name="TTLOCK_KEYBOARD_PWD_TYPE">TTLOCK_KEYBOARD_PWD_TYPE 密码类型</span>  
 [更多信息](../参数声明/智能锁参数.md#TTLOCK_KEYBOARD_PWD_TYPE)  
