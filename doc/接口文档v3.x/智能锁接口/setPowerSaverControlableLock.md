# 通通锁蓝牙模块通信插件接口v3.x - setPowerSaverControlableLock
[返回接口文档](../../README.md)  
<br />
...
## 参数说明 
 ...
 |----------------------|---------------------------------------------------------------------------|--------------|----------------|-----------|
 |option                |[TTLockSetPowerSaverControlableLock](#TTLockSetPowerSaverControlableLock)  |Y             |IN              |完整参数|
 |lockMac               |string                                                                     |Y             |IN              |关联的智能锁MAC地址, 格式："AA:BB:CC:DD:EE:FF"|
 |lockData              |string                                                                     |Y             |IN              |**管理员**电子钥匙数据|
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)                                          |N             |OUT             |设备断开连接回调|
<br />

### <span name="TTLockSetPowerSaverControlableLock">设置取电开关关联的智能锁完整参数 TTLockSetPowerSaverControlableLock</span>  
 |PARAMS                |TYPE                               |REQUIRED       |IN/OUT          |DESCRIPTION|
 |----------------------|-----------------------------------|---------------|----------------|-----------|
 |lockMac               |string                             |Y              |IN              |关联的智能锁MAC地址, 格式："AA:BB:CC:DD:EE:FF"|
 |lockData              |string                             |Y              |IN              |**管理员**电子钥匙数据|
