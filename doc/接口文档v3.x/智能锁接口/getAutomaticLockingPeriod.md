# 通通锁蓝牙模块通信插件接口v3.x - getAutomaticLockingPeriod
[返回接口文档](../../../README.md)  
<br />
...
function getAutomaticLockingPeriod(lockData: string, disconnectCallback?: TTLockCallback): Promise<TTLockGetAutomaticLockingPeriodResult>
```  
<br />
