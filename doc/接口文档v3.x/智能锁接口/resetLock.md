# 通通锁蓝牙模块通信插件接口v3.x - resetLock
[返回接口文档](../../README.md)  
<br />

## 方法
```
function resetLock(option: TTLockReset): Promise<TTLockError>
function resetLock(lockData: string, disconnectCallback?: TTLockCallback): Promise<TTLockError>
```  
<br />
...
## 参数说明 
 ...
 |----------------------|-----------------------------------|--------------|----------------|-----------|
 |option                |[TTLockReset](#TTLockReset)        |Y             |IN              |重置智能锁全部参数|
