# 通通锁蓝牙模块通信插件接口v3.x - deleteICCard
[返回接口文档](../../../README.md)  
<br />

## 方法
```
function deleteICCard(option: TTLockDeleteICCard): Promise<TTLockError>
...
## 参数说明 
 ...
 |----------------------|-------------------------------------------------------|--------------|----------------|-----------|
 |option                |[TTLockDeleteICCard](#TTLockDeleteICCard)              |Y             |IN              |全部参数|
 |cardNum               |number                                                 |Y             |IN              |IC卡卡号|
 |lockData              |string                                                 |Y             |IN              |**管理员**电子钥匙数据|
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)                      |N             |OUT             |设备断开连接回调|
<br />

### <span name="TTLockDeleteICCard">删除IC卡全部参数 TTLockDeleteICCard</span>  
 |PARAMS                |TYPE                                           |REQUIRED      |IN/OUT          |DESCRIPTION|
 |----------------------|-----------------------------------------------|--------------|----------------|-----------|
 |cardNum               |number                                         |Y             |IN              |IC卡卡号|
 |lockData              |string                                         |Y             |IN              |**管理员**电子钥匙数据|
