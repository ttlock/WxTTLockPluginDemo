# 通通锁蓝牙模块通信插件接口v3.x - getLockSoundWithSoundVolume
[返回接口文档](../../../README.md)  
<br />
...
function getLockSoundWithSoundVolume(lockData: string, disconnectCallback?: TTLockCallback): Promise<TTLockGetLockSoundWithSoundVolumeResult>
```  
<br />
