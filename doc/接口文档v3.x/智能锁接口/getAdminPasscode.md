# 通通锁蓝牙模块通信插件接口v3.x - getAdminPasscode
[返回接口文档](../../README.md)  
<br />
...
function getAdminPasscode(lockData: string, disconnectCallback?: TTLockCallback): Promise<TTLockGetAdminPasscodeResult>
```  
<br />
...
## 参数说明 
 ...
 |----------------------|---------------------------------------------------|--------------|----------------|-----------|
 |option                |[TTLockGetAdminPasscode](#TTLockGetAdminPasscode)  |Y             |IN              |完整参数|
 |lockData              |string                                             |Y             |IN              |**管理员**电子钥匙数据|
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)                  |N             |OUT             |设备断开连接回调|
<br />

### <span name="TTLockGetAdminPasscode">查询管理员密码完整参数 TTLockGetAdminPasscode</span>  
 |PARAMS                |TYPE                                               |REQUIRED      |IN/OUT          |DESCRIPTION|
 |----------------------|---------------------------------------------------|--------------|----------------|-----------|
 |lockData              |string                                             |Y             |IN              |**管理员**电子钥匙数据|
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)                  |N             |OUT             |设备断开连接回调|
...
### <span name="TTLockGetAdminPasscodeResult">管理员密码查询结果 TTLockGetAdminPasscodeResult extends TTLockError</span>  
