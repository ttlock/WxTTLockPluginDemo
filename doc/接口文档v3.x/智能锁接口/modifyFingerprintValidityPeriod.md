# 通通锁蓝牙模块通信插件接口v3.x - modifyFingerprintValidityPeriod
[返回接口文档](../../README.md)  
<br />

## 方法
```
function modifyFingerprintValidityPeriod(option: TTLockModifyFingerprintPeriod): Promise<TTLockError>
...
## 参数说明 
 ...
 |----------------------|-------------------------------------------------------------------|--------------|----------------|-----------|
 |option                |[TTLockModifyFingerprintPeriod](#TTLockModifyFingerprintPeriod)    |Y             |IN              |全部参数|
 |startDate             |number                                                             |Y             |IN              |指纹有效期开始时间，生效值精确到分钟|
 |endDate               |number                                                             |Y             |IN              |指纹有效期结束时间，生效值精确到分钟|
 |fingerprintNum        |number                                                             |Y             |IN              |指纹号|
 |lockData              |string                                                             |Y             |IN              |**管理员**电子钥匙数据|
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)                                  |N             |OUT             |设备断开连接回调|
<br />

### <span name="TTLockModifyFingerprintPeriod">修改指纹有效期全部参数 TTLockModifyFingerprintPeriod</span>  
 |PARAMS                |TYPE                                           |REQUIRED      |IN/OUT          |DESCRIPTION|
 |----------------------|-----------------------------------------------|--------------|----------------|-----------|
 |startDate             |number                                         |Y             |IN              |指纹有效期开始时间，生效值精确到分钟|
 |endDate               |number                                         |Y             |IN              |指纹有效期结束时间，生效值精确到分钟|
