# 通通锁蓝牙模块通信插件接口v3.x - deletePasscode
[返回接口文档](../../README.md)  
<br />

## 方法
```
function deletePasscode(option: TTLockDeletePasscode): Promise<TTLockError>
...
## 参数说明 
 ...
 |----------------------|-----------------------------------------------|--------------|----------------|-----------|
 |option                |[TTLockDeletePasscode](#TTLockDeletePasscode)  |Y             |IN              |删除密码全部参数|
 |passcode              |string                                         |Y             |IN              |待删除的密码值，0-9组成的4-9位长度字符串|
 |lockData              |string                                         |Y             |IN              |**管理员**电子钥匙数据|
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)              |N             |OUT             |设备断开连接回调|
<br />

### <span name="TTLockDeletePasscode">删除密码全部参数 TTLockDeletePasscode</span>  
 |PARAMS                |TYPE                                           |REQUIRED      |IN/OUT          |DESCRIPTION|
 |----------------------|-----------------------------------------------|--------------|----------------|-----------|
 |passcode              |string                                         |Y             |IN              |待删除的密码值，0-9组成的4-9位长度字符串|
 |lockData              |string                                         |Y             |IN              |**管理员**电子钥匙数据|
