# 通通锁蓝牙模块通信插件接口v3.x - createCustomPasscode
[返回接口文档](../../README.md)  
<br />
...
): Promise<TTLockCreateCustomPasscodeResult>
```  
<br />
...
## 参数说明 
 ...
 |----------------------|-----------------------------------------------------------|--------------|----------------|-----------|
 |option                |[TTLockCreateCustomPasscode](#TTLockCreateCustomPasscode)  |Y             |IN              |全部参数|
...
### <span name="TTLockCreateCustomPasscode">写入自定义密码全部参数 TTLockCreateCustomPasscode</span>  
 |PARAMS                |TYPE                                           |REQUIRED   |IN/OUT          |DESCRIPTION|
 |----------------------|-----------------------------------------------|-----------|----------------|-----------|
 |passcode              |string                                                     |Y             |IN              |待写入的密码值，0-9组成的4-9位长度字符串|
 |startDate             |string                                                     |Y             |IN              |密码有效期开始时间|
