...
function connectGateway(deviceFromScan: TTGatewayFromScan, disconnectCallback?: TTLockCallback): Promise<TTLockError>
```  
<br />
...
## 参数说明 
 ...
 |----------------------|---------------------------------------------------|--------------|----------------|-----------|
 |option                |[TTLockConnectGateway](#TTLockConnectGateway)      |Y             |IN              |连接网关全部参数|
...
### <span name="TTLockConnectGateway">连接网关全部参数 TTLockConnectGateway</span>  
 |PARAMS                |TYPE                                               |REQUIRED      |IN/OUT          |DESCRIPTION|
 |----------------------|---------------------------------------------------|--------------|----------------|-----------|
 |deviceFromScan        |[TTGatewayFromScan](#TTGatewayFromScan)            |Y             |IN              |扫描到的网关设备信息|
 |disconnectCallback    |[TTLockCallback](#TTLockCallback)                  |N             |OUT             |设备断开连接回调|
