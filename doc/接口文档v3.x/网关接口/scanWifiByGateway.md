# 通通锁蓝牙模块通信插件接口v3.x - scanWiFiByGateway
[返回接口文档](../../README.md)  
<br />
...
function scanWiFiByGateway(deviceFromScan: TTGatewayFromScan, disconnectCallback?: TTLockCallback): Promise<TTLockScanWifiByGatewayResult>
```  
<br />
