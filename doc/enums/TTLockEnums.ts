 ...
 * TTLock 错误码
 */
export const TTLOCK_ERROR_CODE = {
    OK: 0, // 操作成功
 ...
 */
export const TTLOCK_READ_RECORD_TYPE = {
    ALL: 1, // 读取锁内所有的操作记录
    NEW: 2, // 读取锁内未被读取的操作记录
} as const;
 ...
 */
export const TTLOCK_KEYBOARD_PWD_TYPE = {
    PERMANENT: 1, // 永久密码
    ONCE: 2, // 单次密码
    LIMIT: 3, // 限时密码
    CYCLE: 4, // 循环密码
 ...
 * @description 梯控工作模式
 */
export const TTLOCK_LIFT_WORKMODE = {
 ...
 */
export const TTLOCK_SWITCH_CONFIG_TYPE = {
 ...
 */
export const TTLOCK_PASSAGE_WORKMODE = {
    WEEKLY: 1, // 周循环
    MONTHLY: 2, // 日循环
} as const;
 ...
 * @description 智能锁音量
 */
export const TTLOCK_SOUND_VOLUME = {
    ON: -1, // 开启
    OFF: 0, // 关闭锁声音
    FIRST_LEVEL: 1, // 一级
    SECOND_LEVEL: 2, // 二级
