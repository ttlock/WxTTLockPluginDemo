...
## 1.变量 LOCK_BLE_UUID 为锁蓝牙模块的uuid  -1.4.0版本无修改

## 2.变量 LOCK_TYPE_V3 三代锁  -1.4.0版本无修改

## 3.方法 获取当前锁类型 -1.4.0版本无修改
...
## 4.方法 判断设备是否允许远程开锁, 返回布尔值  -1.4.0版本无修改
...
## 5.方法 蓝牙开锁接口   -1.4.0版本增加服务器时间参数，删除部分返回值
...
## 10.方法 校准锁时间 -1.4.0修复钥匙不在有效期内无法校准锁时间的问题，删除部分返回值
